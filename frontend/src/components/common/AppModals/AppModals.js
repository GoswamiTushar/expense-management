...
import EditExpenseModal from '../../expenses/EditExpenseModal/EditExpenseModal';
...
export default function AppModals({
  ...
  const userMap = {};
  if (data.currentUser) {
    userMap[data.currentUser._id || data.currentUser.id] = data.currentUser;
  }
  ...
  return (
    <>
      ...
      />
      <EditExpenseModal
        visible={activeModal === 'showEditExpense'}
      ...
      />
      <SettleUpModal
        visible={activeModal === 'showSettle'}
        onClose={close}
        onSubmit={onSettle}
        creditor={settleWith?.user}
        debtor={data.currentUser}
        property={data.activeProperty}
        defaultAmount={settleWith?.amount}
      />
      <PropertyPickerModal
        visible={activeModal === 'showPropPicker'}
        onClose={close}
        properties={data.properties}
        activeProperty={data.activeProperty}
        onSelectProperty={data.setActiveProperty}
        onOpenAddProperty={() => setM('showAddProp')}
        onOpenJoinInvite={() => setM('showAcceptInvite')}
      />
      <AddPropertyModal
        visible={activeModal === 'showAddProp'}
        onClose={close}
      ...
      />
      <ChronoAuditLogModal
        visible={activeModal === 'showAudit'}
        onClose={close}
        expenses={data.expenses}
      />
      <EditProfileModal
        visible={activeModal === 'showProfile'}
        onClose={close}
        currentUser={data.currentUser}
      ...
      />
      <InvitePartnerModal
        visible={activeModal === 'showInvitePartner'}
        onClose={close}
        property={data.activeProperty}
        currentUser={data.currentUser}
      ...
      />
      <AcceptInviteModal
        visible={activeModal === 'showAcceptInvite'}
        onClose={close}
