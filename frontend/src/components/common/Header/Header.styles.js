...
export const styles = StyleSheet.create({
  container: { backgroundColor: colors.surfaceDark, paddingTop: 10, paddingBottom: 12, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: colors.borderDark },
