    ...
    <View style={styles.container}>
      <View style={styles.topRow}>
        <View style={styles.brandBox}>
          <View style={styles.brandIcon}><Ionicons name="home" size={15} color={colors.white} /></View>
          <View>
        ...
        <View style={styles.actionGroup}>
          {activeProperty && (
            <TouchableOpacity style={styles.iconBtn} onPress={onOpenInvitePartner}>
              <Ionicons name="person-add-outline" size={15} color={colors.textDark} />
            </TouchableOpacity>
          )}
          <TouchableOpacity style={styles.iconBtn} onPress={onOpenAuditLog}>
            <Ionicons name="receipt-outline" size={15} color={colors.textDark} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.iconBtn} onPress={onOpenNotifications}>
            <Ionicons name="notifications-outline" size={15} color={colors.textDark} />
          ...
          <TouchableOpacity onPress={onOpenProfile} activeOpacity={0.7}>
            <Avatar name={currentUser?.name} initials={currentUser?.initials} color={currentUser?.color} size={28} />
          </TouchableOpacity>
        </View>
      </View>
