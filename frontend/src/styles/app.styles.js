...
export const styles = StyleSheet.create({
  ...
  title: { color: colors.textDark, fontSize: 15.5, fontWeight: '800' },
  sub: { color: colors.textMuted, fontSize: 11.5 },
  headerActions: { flexDirection: 'row', gap: 8 },
  btn: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surfaceDark, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: colors.borderDark },
  btnText: { color: colors.textDark, fontSize: 11.5, fontWeight: '600' },
